...
WORKDIR /var/www/html# Usa PHP 8.3 con FPM
FROM php:8.3-fpm
...
# Script de entrada para ajustar el puerto dinámico
COPY entrypoint.sh /entrypoint.sh
RUN chmod +x /entrypoint.sh

# Usa el entrypoint que sustituye el puerto y luego lanza supervisord
CMD ["/entrypoint.sh"]
